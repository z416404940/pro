class bindTel {
  ...
  build() {
    let html = `
      ...
      <div class="layui-input-block">
          <input type="text" name="mail" autocomplete="off" placeholder="新手机号：" class="layui-input"/>
      </div>
      </div>
      <div class="layui-form-item">
          <button type="button" class="layui-btn layui-btn-primary">获取验证码</button>
          <div class="layui-input-inline">
          <input type="text" name="mailVerification" lay-verify="required" placeholder="请输入新手机号" autocomplete="off" class="layui-input">
          </div>
          </div>
          <div style="margin-bottom: 10px;margin-top: 10px">
      ...
      <button type="button" class="layui-btn" id="yesTel">确定</button>
          </center>
          </div>
          </div>
          </div>
