class bindTelByMail {
  ...
  build() {
    let html = `
      ...
      <li id="registerLi"style="display: none">绑定手机-></li>
      <li id="successLi"style="display: none">绑定成功</li><!--style="display: none"-->
          ...
          <label class="layui-form-label">原邮箱号：</label>
      <div class="layui-input-block">
          <input type="text" name="tel" autocomplete="off" value="939026701@qq.com" class="layui-input"readonly/>
      </div>
      </div>
      <div class="layui-form-item">
      ...
      <div class="layui-input-block">
          <input type="text" name="mail" autocomplete="off" placeholder="请输入手机号" class="layui-input"/>
      </div>
      </div>
      <div class="layui-form-item">
          <button type="button" class="layui-btn layui-btn-primary">获取验证码</button>
          ...
          <h3 style="color: green">恭喜您，手机绑定成功！！</h3>
      </div>
      <button type="button" class="layui-btn" id="yesTelByMail">确定</button>
          </center>
          </div>
          </div>
          </div>
